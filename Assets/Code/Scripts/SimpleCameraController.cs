...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        void Start()
        {
            // Create input actions for camera control
            ...
            // Configure input bindings for different input devices
        ...
        {
#if ENABLE_INPUT_SYSTEM
            bool rightMouseButtonDown = Mouse.current != null ? Mouse.current.rightButton.wasPressedThisFrame : false;
            rightMouseButtonDown |= Gamepad.current != null ? Gamepad.current.rightTrigger.wasPressedThisFrame : false;
        ...
        {
#if ENABLE_INPUT_SYSTEM
            bool rightMouseButtonUp = Mouse.current != null ? Mouse.current.rightButton.wasReleasedThisFrame : false;
            rightMouseButtonUp |= Gamepad.current != null ? Gamepad.current.rightTrigger.wasReleasedThisFrame : false;
